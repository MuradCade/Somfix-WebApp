...
changepwdbtn.addEventListener('click',function (e) {
        ...
        if(newpwd.value == ''){
            ...
            errormsg.innerHTML = "Empty  password feild";
        }else if(re_enterpwd.value == ''){
            errormsg.style.display = 'block';
            successmsg.style.display = 'none';
            errormsg.innerHTML = "Empty re-enter password feild";
            ...
            successmsg.style.display = 'block';
                    successmsg.innerHTML = 'password updated successfully';
                }).catch((error) => {
                    // An error ocurred
                    errormsg.style.display= 'block';
                    successmsg.style.display = 'none';
                    errormsg.innerHTML = 'password failed to update';
                });
                 }
            });
